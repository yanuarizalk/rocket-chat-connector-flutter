...
class Message {
  ...
  Message.fromMap(Map<String, dynamic>? json) {
    if (json != null) {
      ...
      t = json['t'];
      ts = json['ts'] != null ? (json['ts'] is String ? DateTime.parse(json['ts']) : DateTime.fromMillisecondsSinceEpoch(json['ts']['\$date']) ) : null;
      user = json['u'] != null ? User.fromMap( (json['u'] as Map).cast<String, dynamic>() ) : null;
      rid = json['rid'];
      updatedAt = json['_updatedAt'] != null
          ? ( json['_updatedAt'] is String ? DateTime.parse(json['_updatedAt']) : DateTime.fromMillisecondsSinceEpoch(json['_updatedAt']['\$date']) )
          : null;
      id = json['_id'];
